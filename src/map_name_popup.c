...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_ROUTE_135 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_136 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_OMAOMA_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_137 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
};
    ...
    if (OW_POPUP_GENERATION == GEN_5)
    {
        ...
        switch (popUpThemeId) 
        {
            ...
            case MAPPOPUP_THEME_BW_DEFAULT:
                ...
                //ravetodo: restore the day and night icon feature
