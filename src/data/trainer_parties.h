...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .lvl = 13,
    .species = SPECIES_ARON,
    .moves = {MOVE_METAL_CLAW, MOVE_ROAR, MOVE_TACKLE, MOVE_ROCK_TOMB},
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 13,
    .species = SPECIES_ROCKRUFF,
    .moves = {MOVE_TACKLE, MOVE_DOUBLE_TEAM, MOVE_ROCK_THROW, MOVE_LEER},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 16,
    ...
    .moves = {MOVE_BLOCK, MOVE_HARDEN, MOVE_REST, MOVE_ROCK_TOMB},
    }
};
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .moves = {MOVE_ROCK_SLIDE, MOVE_WAKE_UP_SLAP, MOVE_MACH_PUNCH, MOVE_BULK_UP},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 21,
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .moves = {MOVE_BULLET_SEED, MOVE_ROLLOUT, MOVE_SELF_DESTRUCT, MOVE_SHOCK_WAVE},
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 23,
    .species = SPECIES_PIKACHU,
    .moves = {MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_QUICK_ATTACK, MOVE_AGILITY},
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 24,
    .species = SPECIES_HELIOPTILE,
    .moves = {MOVE_VOLT_SWITCH, MOVE_BULLDOZE, MOVE_QUICK_ATTACK, MOVE_RAZOR_WIND},
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 25,
    .species = SPECIES_SANDY_SHOCKS,
    .moves = {MOVE_CHARGE_BEAM, MOVE_TRI_ATTACK, MOVE_ELECTRIC_TERRAIN, MOVE_MUD_SHOT},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 27,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_ELECTRIC_TERRAIN},
    }
};
...
static const struct TrainerMon sParty_BrendanRoute110Mudkip[] = {
    ...
    .moves = {MOVE_MEGA_DRAIN, MOVE_QUICK_ATTACK, MOVE_DRAGON_BREATH, MOVE_DETECT},
    }
};
...
static const struct TrainerMon sParty_BrendanRoute110Treecko[] = {
    ...
    .moves = {MOVE_DOUBLE_KICK, MOVE_FLAME_CHARGE, MOVE_QUICK_ATTACK, MOVE_AERIAL_ACE},
    }
};
...
static const struct TrainerMon sParty_BrendanRoute110Torchic[] = {
    ...
    .moves = {MOVE_MUD_SHOT, MOVE_WATER_PULSE, MOVE_ROCK_THROW, MOVE_PROTECT},
    }
};
...
static const struct TrainerMon sParty_BrendanRustboroTorchic[] = {
    ...
    .lvl = 16,
    .species = SPECIES_MARSHTOMP,
    .moves = {MOVE_MUD_SHOT, MOVE_WATER_GUN, MOVE_ROCK_THROW, MOVE_PROTECT},
    }
};
...
static const struct TrainerMon sParty_Delvin[] = {
    {
    .iv = TRAINER_PARTY_IVS(5, 5, 5, 5, 5, 5),
    .lvl = 9,
    .species = SPECIES_DIGLETT,
