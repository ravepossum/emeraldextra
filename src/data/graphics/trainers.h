...
const u32 gTrainerFrontPic_ORASBrendan[] = INCBIN_U32("graphics/trainers/front_pics/brendan_oras.4bpp.lz");
const u32 gTrainerPalette_ORASBrendan[] = INCBIN_U32("graphics/trainers/palettes/brendan_oras.gbapal.lz");
...
const u32 gTrainerFrontPic_ORASMay[] = INCBIN_U32("graphics/trainers/front_pics/may_oras.4bpp.lz");
const u32 gTrainerPalette_ORASMay[] = INCBIN_U32("graphics/trainers/palettes/may_oras.gbapal.lz");
...
const u8 gTrainerBackPic_ORASBrendan[] = INCBIN_U8("graphics/trainers/back_pics/brendan_oras.4bpp");
const u8 gTrainerBackPic_ORASMay[] = INCBIN_U8("graphics/trainers/back_pics/may_oras.4bpp");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(LEADER_BRAWLY, LeaderBrawly, -12, 5, 0x1A0),
    TRAINER_SPRITE(LEADER_WATTSON, LeaderWattson,  0, 4, 0x1B0),
    TRAINER_SPRITE(LEADER_FLANNERY, LeaderFlannery, -4, 5, 0x1A0),
    TRAINER_SPRITE(LEADER_NORMAN, LeaderNorman,  0, 5, 0x1A0),
    TRAINER_SPRITE(LEADER_WINONA, LeaderWinona, -14, 5, 0x1A0),
    TRAINER_SPRITE(LEADER_TATE_AND_LIZA, LeaderTateAndLiza, -22, 2, 0x1D8),
    TRAINER_SPRITE(LEADER_JUAN, LeaderJuan,  0, 7, 0x188),
    ...
    TRAINER_SPRITE(ORAS_BRENDAN, ORASBrendan),
    TRAINER_SPRITE(ORAS_MAY, ORASMay),
};
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(ORAS_BRENDAN, 4, ORASBrendan, Palette_ORASBrendan, Hoenn),
    TRAINER_BACK_SPRITE(ORAS_MAY, 4, ORASMay, Palette_ORASMay, Hoenn),
};
