...
static const struct SpritePalette sSpritePalette_MegaTrigger_dark = {sMegaTriggerPal_dark, TAG_GIMMICK_TRIGGER_TILE};
...
static const struct SpritePalette sSpritePalette_MegaIndicator_dark = {sMegaIndicatorPal_dark, TAG_MEGA_INDICATOR_PAL};
