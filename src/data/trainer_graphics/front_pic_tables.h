const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_ORAS_BRENDAN] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_ORAS_MAY] = {.size = 8, .y_offset = 1},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(ORAS_BRENDAN, gTrainerFrontPic_ORASBrendan, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(RS_MAY, gTrainerFrontPic_RubySapphireMay, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ORAS_MAY, gTrainerFrontPic_ORASMay, TRAINER_PIC_SIZE),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(ORAS_BRENDAN, gTrainerPalette_ORASBrendan),
    TRAINER_PAL(RS_MAY, gTrainerPalette_RubySapphireMay),
    TRAINER_PAL(ORAS_MAY, gTrainerPalette_ORASMay),
};
