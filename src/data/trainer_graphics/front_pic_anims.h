...
static const union AnimCmd *const sAnims_ORASBrendan[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_ORASMay[] ={
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_ORAS_BRENDAN] = sAnims_ORASBrendan,
    [TRAINER_PIC_ORAS_MAY] = sAnims_ORASMay,
};
