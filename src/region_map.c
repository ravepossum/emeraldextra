...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_OMAOMA_TOWN] = {MAP_GROUP(OMAOMA_TOWN), MAP_NUM(OMAOMA_TOWN), HEAL_LOCATION_OMAOMA_TOWN},
    ...
    [MAPSEC_ROUTE_135] = {MAP_GROUP(ROUTE135), MAP_NUM(ROUTE135), HEAL_LOCATION_NONE},
};
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_OMAOMA_TOWN:
        return FlagGet(FLAG_VISITED_OMAOMA_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
