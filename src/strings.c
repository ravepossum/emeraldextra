...
const u8 gText_BatteryRunDry[] = _("You do not have a functioning Real\nTime Clock (RTC).\pFor best results, please use a\ndifferent device or emulator.\pIf you cannot, you must rest at a\nPokémon Center to pass time.");
